...
<div class="col-md-12">
    <div class="card card-danger">
        <div class="card-header">
            <h3 class="card-title">Mantenimiento de Medicamentos</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_medicamento" placeholder="Ingrese Medicamento" maxlength="50" onkeypress="return soloLetras(event)">
                    <br>
                </div>

                <div class="col-lg-12">
                    <label for="">Alias</label>
                    <input type="text" class="form-control" id="txt_alias" placeholder="Ingrese El Alias del Medicamento" maxlength="50" onkeypress="return soloLetras(event)">
                    <br>
                </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="text-align: center;"> <b> Editar de Medicamentos</b></h4>
                <button type="button" class="close" data-dismiss="modal"> &times;</button>
            </div>
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_medicamento_nuevo_editar" placeholder="Ingrese Medicamento" maxlength="50" onkeypress="return soloLetras(event)" >
                    <br>
                </div>

                <div class="col-lg-12">
                    <label for="">Alias</label>
                    <input type="text" class="form-control" id="txt_alias_editar" placeholder="Ingrese El Alias del Medicamento" maxlength="50" onkeypress="return soloLetras(event)">
                    <br>
                </div>
